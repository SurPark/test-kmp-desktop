...
import multiplatform_app.composeapp.generated.resources.pretendard_regular
...
fun LoginScreen(navigateToMain: () -> Unit) {
    Column(
        ...
        Text(
            ...
            fontFamily = FontFamily(Font(Res.font.pretendard_regular)),
        ...
        TextButton(
            modifier = Modifier.padding(horizontal = 8.dp, vertical = 4.dp).widthIn(min = 200.dp),
            onClick = { uriHandler.openUri("https://github.com/SurPark/test-kmp-desktop") },
        ) {
